...
{
  {
    /* .hdb = */ {
      ...
      /* .isr2_src = */   OSEE_TC_SRC_ASCLIN3TX
    },
    /* .p_tcb          = */ &osEE_tcb_array[0U],
    /* .tid            = */ 0U,
    /* .task_type      = */ OSEE_TASK_TYPE_ISR2,
    /* .task_func      = */ asclin3TxISR,
    /* .ready_prio     = */ 144U,
    /* .dispatch_prio  = */ 144U,
    /* .max_num_of_act = */ 1U
  },
  ...
  },
  {
    ...
    /* .tid            = */ 12U,
    /* .task_type      = */ OSEE_TASK_TYPE_BASIC,
    /* .task_func      = */ TASK_FUNC(WallFollowTask),
    /* .ready_prio     = */ 3U,
    /* .dispatch_prio  = */ 3U,
    /* .max_num_of_act = */ 1U
  },
  {
    ...
    /* .tid            = */ 13U,
    /* .task_type      = */ OSEE_TASK_TYPE_BASIC,
    /* .task_func      = */ TASK_FUNC(AvoidObstacleTask),
    /* .ready_prio     = */ 4U,
    /* .dispatch_prio  = */ 4U,
    /* .max_num_of_act = */ 1U
  },
