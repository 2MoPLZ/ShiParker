...
# 3 "C:\\Users\\USER\\Desktop\\AUTODR~1\\TC275\\hall_Driver.c" 2
...
void initHall(void)
{
    ...
    IfxPort_setPinMode(&(*(Ifx_P*)0xF003A200u), 1, IfxPort_Mode_inputPullUp);
    g_ERUconfig0.reqPin = &IfxScu_REQ14_P02_1_IN;
    ...
    g_ERUconfig0.src = &(*(Ifx_SRC*)0xF0038000u).SCU.SCU.ERU[(int)g_ERUconfig0.outputChannel];
    IfxSrc_init(g_ERUconfig0.src, IfxSrc_Tos_cpu0, 10);
    IfxSrc_enable(g_ERUconfig0.src);


    IfxPort_setPinMode(&(*(Ifx_P*)0xF003B000u), 3, IfxPort_Mode_inputPullUp);
    g_ERUconfig1.reqPin = &IfxScu_REQ3_P10_3_IN;
    ...
    g_ERUconfig1.src = &(*(Ifx_SRC*)0xF0038000u).SCU.SCU.ERU[(int)g_ERUconfig1.outputChannel];
    IfxSrc_init(g_ERUconfig1.src, IfxSrc_Tos_cpu0, 11);
    IfxSrc_enable(g_ERUconfig1.src);


    IfxPort_setPinMode(&(*(Ifx_P*)0xF003B100u), 10, IfxPort_Mode_inputPullUp);
    g_ERUconfig2.reqPin = &IfxScu_REQ12_P11_10_IN;
    ...
    g_ERUconfig2.src = &(*(Ifx_SRC*)0xF0038000u).SCU.SCU.ERU[(int)g_ERUconfig2.outputChannel];
    IfxSrc_init(g_ERUconfig2.src, IfxSrc_Tos_cpu0, 12);
    IfxSrc_enable(g_ERUconfig2.src);


    IfxPort_setPinMode(&(*(Ifx_P*)0xF003C000u), 9, IfxPort_Mode_inputPullUp);
    g_ERUconfig3.reqPin = &IfxScu_REQ11_P20_9_IN;
    ...
    g_ERUconfig3.src = &(*(Ifx_SRC*)0xF0038000u).SCU.SCU.ERU[(int)g_ERUconfig3.outputChannel];
    IfxSrc_init(g_ERUconfig3.src, IfxSrc_Tos_cpu0, 15);
