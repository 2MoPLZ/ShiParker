...
void initHall(void)
{
    ...
    IfxPort_setPinMode(&(*(Ifx_P*)0xF003B500u), 5, IfxPort_Mode_inputPullUp);
    g_ERUconfig2.reqPin = &IfxScu_REQ13_P15_5_IN;
    ...
    IfxPort_setPinMode(&(*(Ifx_P*)0xF003B500u), 4, IfxPort_Mode_inputPullUp);
    g_ERUconfig3.reqPin = &IfxScu_REQ0_P15_4_IN;
