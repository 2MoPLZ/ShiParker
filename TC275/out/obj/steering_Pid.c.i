# 1 "C:\\Users\\USER\\Desktop\\WORKSP~1\\SHIPAR~1\\TC275\\steering_Pid.c"
...
# 2 "C:\\Users\\USER\\Desktop\\WORKSP~1\\SHIPAR~1\\TC275\\steering_Pid.c" 2
...
# 4 "C:\\Users\\USER\\Desktop\\WORKSP~1\\SHIPAR~1\\TC275\\steering_Pid.c" 2

 get_time_us()
{
    return IfxStm_get(&(*(Ifx_STM*)0xF0000000u)) / (100000000UL / 1000000UL);
}
...
double get_position(double adjusted_dist_a, double adjusted_dist_b){
    double alpha = atan((adjusted_dist_a-adjusted_dist_b)/11.5);
    return alpha;
}
...
DriveCommand wall_follow_control(double dist_a, double dist_b){
    ...
    if (fabsf(steering_angle) > 20.0f * (3.14159265359 / 180.0f))
        speed = 0.5f;
    else if (fabsf(steering_angle) > 10.0f * (3.14159265359 / 180.0f))
        speed = 1.0f;
    else
        speed = 1.5f;
