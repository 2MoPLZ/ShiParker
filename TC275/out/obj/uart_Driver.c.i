...
# 3 "C:\\TUNNEL~1\\TC275\\uart_Driver.c" 2
...
void myprintfSerial(const char *fmt, ...)
{
    ...
    IfxAsclin_Asc_write(&g_AsclinStm.drivers.asc, &txData, &g_AsclinStm.count, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));
}
...
void serialize_actuator_packet(const struct ActuatorPacket *packet, uint8 *buffer)
{
    ...
    buffer[11 - 1] = calculate_checksum(buffer, 11 - 1);
}
