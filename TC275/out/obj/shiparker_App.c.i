...
void turn90(void);
# 2 "C:\\Users\\USER\\Desktop\\AUTODR~1\\TC275\\shiparker_App.c" 2
...
void FuncAvoidObstacleTask ( void )
{
...
void calculateCurrentPos() {
    ...
    {
        case 0:
            currentPosition.y = 4.2 * getHallCntAvg();
            break;
        case 1:
            currentPosition.x = 4.2 * getHallCntAvg();
            break;
        case 2:
            currentPosition.y = 4.2 * getHallCntAvg();
            break;
...
# 293 "C:\\Users\\USER\\Desktop\\AUTODR~1\\TC275\\shiparker_App.c"
